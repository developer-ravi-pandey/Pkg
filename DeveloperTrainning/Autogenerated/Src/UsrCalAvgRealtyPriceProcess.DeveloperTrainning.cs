namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalAvgRealtyPriceProcessMethodsWrapper

	/// <exclude/>
	public class UsrCalAvgRealtyPriceProcessMethodsWrapper : ProcessModel
	{

		public UsrCalAvgRealtyPriceProcessMethodsWrapper(Process process)
			: base(process) {
